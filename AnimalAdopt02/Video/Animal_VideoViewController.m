...
@interface Animal_VideoViewController ()
{
    NSURL *url;
...
@implementation Animal_VideoViewController
...
-(void)viewDidLoad
{
    ...
    //url = [NSURL URLWithString:@"http://211.22.108.181/AmlApp/App/Recei_rescue.aspx?Page=section2"];
    
    //By Richard 2017.03.31
    url = [NSURL URLWithString:@"http://163.29.36.110/AmlApp/App/Recei_rescue.aspx?Page=section2"];
