//
//  Happy_transfer_stationViewController.m
//  AnimalAdopt02
//
...
@interface Happy_transfer_stationViewController ()
{
    NSURL *url;
...
@implementation Happy_transfer_stationViewController
...
-(void)viewDidLoad
{
    ...
    //url = [NSURL URLWithString:@"http://211.22.108.181/AmlApp/App/Recei_rescue.aspx?Page=section7"];
    
    url = [NSURL URLWithString:@"http://163.29.36.110/AmlApp/App/Recei_rescue.aspx?Page=section7"];
...
-(void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    ...
    //[MBProgressHUD hideAllHUDsForView:self.view animated:YES];
    /*
    NSString *html = @"<html><head><style>body {font-size:88px; color:black ; background-color:FFFFFF}</style></head><body>aaaa頁面下載錯誤,請檢查網路是否開啟及連線狀況,謝謝。</body></html>";
    
    [self.myWeb loadHTMLString:html baseURL:nil];
     */
    
    /*
    NSString *filePath = [[NSBundle mainBundle] pathForResource:@"AnimalAdopt02/noicon/nowifi" ofType:nil];*/
    
    
    /*
    NSURL *baseURL = [[NSBundle mainBundle] URLForResource:@"nowifi" withExtension:@"html" subdirectory:@"AnimalAdopt02/noicon"];
    
    [self.myWeb loadRequest:[NSURLRequest requestWithURL:baseURL]];
    */
