...
@interface Shelter_RescueViewController ()
{
    NSURL *url;
...
@implementation Shelter_RescueViewController
...
-(void)viewDidLoad
{
    ...
    //url = [NSURL URLWithString:@"http://211.22.108.181/AmlApp/App/Recei_rescue.aspx?Page=section5"];
    
    url = [NSURL URLWithString:@"http://163.29.36.110/AmlApp/App/Recei_rescue.aspx?Page=section5"];
